...
{{--                    <img src="/images/studio-22.jpg" alt="facility" class="img-fluid my-1" style="object-fit: cover; max-height: 188px;">--}}
    ...
    <div class="container">
        ...
        <div class="row mb-5 p-4 rounded shadow gradient-splash">
            <div class="col-sm-4 d-flex justify-content-center align-items-center">
                <img src="/images/staff-lindsey-claire.jpg" class="img-fluid rounded" style="height: 439px; width: 349px; object-fit: cover;">
            </div>
            <div class="col-sm-8 rounded pb-5">
                <h3 class="pb-0 mb-0 text-white">Lindsey-Claire Muse Hutchins <span style="font-size: 0.6em; opacity: 60%;">Studio Owner & Artistic Director</span></h3>
...
{{--                        Allyson Roberston currently attends Mississippi College. She has been dancing in her hometown of Zachary, Louisiana for 6 years where she competed with her studio’s competition team for 5 years. She has a true passion for teaching young dancers and watching them grow into their personalities as young adults. Allyson is in her 4th year working for us at the LCDC.--}}
        ...
        <div class="row my-5 p-4 rounded shadow gradient-splash">
            ...
            <div class="col-sm-8 rounded pb-5">
                <h3 class="pb-0 mb-0 text-white">Maegan Winter</h3>
                <div class="rounded p-4" style="background: white; width: 100%; height: 100%;">
                    <p class="m-0 p-0" style="height: 100%;">
                        Maegan Winter is currently attending Belhaven University where she is a double major in Dance and Sports Medicine/ Exercise Science. She spent her early years growing up in Europe before moving to Colorado, her home state.
                        <br>During high school Maegan was an intern teacher in varied styles and ages in the dance classroom. Maegan has performed in musical theater shows since 8th grade; her favorite roles include Lina Lamont, Peter Pan and a Manhattan Newsie. Her favorite styles of dance are contemporary and jazz.
                        <br>She is passionate about dancing, teaching and educating her students in dance science (anatomy and kinesiology).
                        <br>This is Maegan’s first year at LCDC and she is excited to join our team of teachers.
                    </p>
                </div>
            </div>
        </div>
